...
const LineChart: React.FC = () => {
  ...
  return (
    <div className="w-full col-span-12 flex flex-col rounded-2xl border border-stroke bg-greentheme2 px-5 pb-5 pt-7.5 shadow-default shadow-md dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:col-span-6">
